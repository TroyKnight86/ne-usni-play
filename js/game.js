/* =====================================================================
   НЕ УСНИ — кирпич №2: перепланировка (Антон, 29.08)
...
SCENES.bedroom = { build() {
  ...
  glowHot({ left:'6.5%', top:'36.6%', width:'17.0%', height:'42.0%' },
    ...
    dialog('vera_corner', [
      ...
      { narr:true, t:'За раму зеркала заткнуто фото: Вера смеётся — не в камеру, а на того, кто снимал.\nСнимал ты. Помнишь ли ты этот день — вопрос отдельный.' },
    ])));
...
SCENES.bathroom = { build() {
  ...
  if (S.time === 'morning' && !S.flags.introShown) {
    ...
    say('', '06:40. Ты проснулся за минуту до будильника. Так всегда.\nНоги сами принесли в ванную — автопилот включается раньше тебя.\nЛампочка над зеркалом моргает. Всё руки не доходят.', true);
  } else {
