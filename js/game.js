...
SCENES.corridor = { build() {
  ...
  // проём кухни — в нём видна НАША кухня (сквозная согласованность кадров)
  glowHot({ left:'65.3%', top:'60.9%', width:'4.6%', height:'8.8%' },
    'polygon(65.4% 61.3%, 70.0% 60.9%, 69.8% 69.6%, 65.3% 69.8%)', 'кухня',
    () => goScene('kitchen'));
  // за правым поворотом — ДВЕ двери (планировка Антона, канон):
  // плашки гостиной/спальни ЖДУТ переразметки по корню v7
